            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2 w-20">
                            <img src="{{ asset('images/watching-a-movie.png') }}" class="w-12 h-12 object-contain">
                        </div>
                        ...
                        <div class="grid gap-6 lg:grid-cols-8 lg:gap-8">
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img src="{{ asset('images/Untitled-design-3.webp') }}" alt="">
                                </div>
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-4xl font-semibold text-black">Movies</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                discover the list of movies NOW!!!
                                            </p>
                                        </div>
                                    </div>
